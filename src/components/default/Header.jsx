...
export default function Header() {
  ...
  return (
    <div className="flex justify-between items-center py-4 px-14 border-b-2 border-secondary bg-theme text-gold-matte">
      <Link to="/">
        <h1 className="font-[Emilys_Candy] text-4xl italic">Chocolaterie</h1>
      </Link>
      <div className="flex items-center gap-4">
        <Link to="/login" className="hover:text-hover">
          <Icon className="fa-regular fa-user text-2xl mr-4 cursor-pointer" />
        </Link>
        <Link to="/shop-cart" className="hover:text-hover">
